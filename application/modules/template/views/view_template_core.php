  ...
  <aside class="main-sidebar elevation-4 sidebar-light-success">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img style="margin-top: 10px;" src="<?php echo base_url(); ?>assets/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() ?>dashboard" class="nav-link <?php echo ($namamodule == "dashboard") ? "active": "" ?>">
              <i class="far fa-circle nav-icon fas fa-home"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url() ?>penghuni_ruang" class="nav-link <?php echo ($namamodule == "penghuni_ruang") ? "active": "" ?>">
              <i class="far fa-circle nav-icon fas fa-users"></i>
              <p>Penghuni</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url() ?>pindah_ruang" class="nav-link">
              <i class="far nav-icon fas fa-solid fa-edit"></i>
              <p>Pindah Ruangan</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url() ?>setting_gedung" class="nav-link">
              <i class="far nav-icon fa-solid fa-building"></i>
              <p>Setting Gedung</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url() ?>seting_ruangan" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() ?>rekap_pembayaran" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() ?>pendapatan" class="nav-link">
...
<script type="module" src="<?php echo base_url() ?>assets/script/index.js"></script>
</body>
</html>
